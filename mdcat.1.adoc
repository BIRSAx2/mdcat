...
+
Valid style names: `html_block`, `inline_html`, `code`, `link`, `image_link`, `quote_border`, `h1_text`, `h2`, `h3`, `h4`, `h5`, `h6`, `footnote`, `math`, `alert_note`, `alert_tip`, `alert_important`, `alert_warning`, `alert_caution`.
